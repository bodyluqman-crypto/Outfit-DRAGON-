...
def outfit_image():
    ...
    # ===== واجهة المستخدم =====
    # خط واضح جدا في أعلى الصورة: DRAGONX1M@
    watermark = "⚡ DRAGONX1M@ ⚡"
    # ظل للخط
    ...
    # الحيوان الأليف إضافي إذا لم يكن ضمن القائمة
    if pet_id:
...
def home():
    return jsonify({
        ...
        'example': 'http://localhost:5000/outfit-image?uid=2129828082&key=DRAGON-TEAM'
    })
